...
l::set('read_blog', 'Den Blog lesen');
...
l::set('send', 'Senden');
l::set('error_email', 'Bitte eine gültige E-Mail-Adresse eingeben');
l::set('error_message', 'Bitte eine Nachricht eingeben (mindestens 10 Zeichen)');
